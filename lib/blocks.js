...
var bitcore = require('bitcore-lib-bzedge');
...
BlockController.prototype.getBlockReward = function(height) {
  // BZEdge subsidy intervals
  var subsidy = 12500;
    if (height < 200001) subsidy = 12500;
    else if (height < 300001 ) subsidy = 2500; //Above block 200,000 we re-target to 1 minute interval. 
    else if ( height < 400001 ) subsidy = 1250;
    else if ( height < 500001 ) subsidy = 625;
    else if ( height < 600001 ) subsidy = 312.5;
    else if ( height < 700001 ) subsidy = 156.25;
    else if ( height < 800001 ) subsidy = 78;
    else if ( height < 1300001 ) subsidy = 39;
    else if ( height < 1800001 ) subsidy = 19.5;
    else if ( height < 2300001 ) subsidy = 8;
    else if ( height < 2800001 ) subsidy = 4;
    else if ( height < 3300001 ) subsidy = 2;
    else if ( height < 4875001 ) subsidy = 1;
    else {
        
            // int halvings = (height - 3102400) / consensusParams.nSubsidyHalvingInterval; // We don't know subsidy halving interval here
